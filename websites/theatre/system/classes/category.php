...
{ 
  ...
  protected $id;
  protected $seats;
  protected $seatsFields;
  protected $elementClasses = ['checkbox' => 'seatBox', 'row' => 'seatRow', 'singleRow' => 'singleSeatRow', 'container' => 'seatContainer', 'rowNumLabel' => 'rowNumber'];
  ...
  function __toString() {
    ...
    // foreach ($this->seats as $seat) { $temp[$seatsList['row']] = '1'; }
    var_dump($seatsList);
    var_dump($temp);
    $row = null;
    $r .= '</div>';
